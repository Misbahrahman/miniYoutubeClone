...
const API_KEY = "AIzaSyB6nKgucp1UYoPqUKDvALfyJAVkssmKSco";
...
function getVideoStats(ArrayStat) {
  ...
  displayViewsDiv.innerHTML += `
    <h1>${ArrayStat[0]}</h1>
    <span>
    <p><span style="background-color: #272727; ">${ArrayStat[2]} Views. ${ArrayStat[3]}</span></p>
    <p> ${ArrayStat[4]}<img style="background-color: #272727;" src="./assets/displayview0.svg"></p> 
    <p><img style="background-color: #272727;" src="./assets/displayview2.svg"> Share</p>
    <p><img style="background-color: #272727;" src="./assets/displayview3.svg"> Save</p>
    <p><img style="background-color: #272727;" src="./assets/displayview4.svg"><p>
    </span>
